...
func SetupBatcher(
	...
	case SequencerBatcherMode:
		...
		seqBatcher, err := batcher.NewSequencerBatcher(ctx, batcherMode.Core, batcherMode.InboxReader, client, batcherMode.DelayedMessagesTargetDelay, seqInbox, batcherMode.Auth, dataSigner)
		if err != nil {
			return nil, err
		}
